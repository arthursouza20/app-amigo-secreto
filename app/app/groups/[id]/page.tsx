...
export default async function GroupIdPage({ params }: { params: Promise<{ id: string }>; }) {
    ...
    const assignedParticipantId = data.participants.find((p) => authUser?.user?.email)?.assigned_to;
        ...
        <main className="container mx-auto py-6">
            <Card className="w-full max-w-3xl mx-auto">
                ...
                <CardContent>
                    ...
                    <TextRevealCard text="Descubra quem você tirou" revealText={assignedParticipant?.name} className="w-full items-center justify-center">
                        <TextRevealCardTitle>
                            Seu amigo secreto
                        </TextRevealCardTitle>
                    </TextRevealCard>
